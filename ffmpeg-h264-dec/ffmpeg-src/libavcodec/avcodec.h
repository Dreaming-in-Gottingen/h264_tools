...
typedef struct AVCodec {
    ...
    /**
     * parse sps to get aligned_width/height and crop_width/height info.
     * crop_left/top use 0 by me, for I have never seen none-zero before.
     */
    int (*get_video_dimension)(AVCodecContext *avctx, int *aligned_width, int *aligned_height, int *crop_width, int *crop_height);
    /**
     * Flush buffers.
...
/* add by zjz
 * get aligned/crop w/h from sps data, in order to alloc right buf to store yuv.
 */
int avcodec_get_video_dimension(AVCodecContext *avctx, int *aligned_width, int *aligned_height, int *crop_width, int *crop_height);
